defmodule Nerves.Runtime.ConfigFSTest do
  ...
  describe "Map to fs overlay" do
    ...
    test "complex multi level map" do
      ...
      assert "level0_path3" in results.folders
      assert "level0_empty" in results.folders
      assert "level0_path2/level1_path2_path1" in results.folders
      assert "level0_path2/level1_path2_path1_path1" in results.folders
      assert "level0_path2/level1_path2_path1_path2" in results.folders
      assert "level0_path3/level1_path3_path1" in results.folders
      assert "level0_path3/level1_path3_path2" in results.folders
      assert "level0_path3/level1_path3_path2/level1_path3_path2_path1/level1_path3_path2_path1_path1" in results.folders
      assert "level0_path3/level1_path3_path3/level1_path4_path3" in results.folders
